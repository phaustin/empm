...
c
	...
	real*8 time_his(m_index, 3)
	integer t_index(mip), t_ip

Creal*8 time_r(m_index), time_x(m_index)
...
c
   	  ...
   	  itime=i_index
C
   	  time_his(itime,2)=radius
CC        time_qv(itime)=A(j_cell,1)
CC        time_T(itime)=A(j_cell,2
          time_his(itime,3)=x(i)
	  time_his(itime,1)=1.0
...
C  write(*,*)'ndrop_index= ',ndrop_index
	  ...
	  write(62)time_time,(time_his(i,2)*1.e6,i=1,ndrop_index)
          write(68)time_time,(time_his(i,3),i=1,ndrop_index)
 	 endif
