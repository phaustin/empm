...
Creal*8 bl_new
	...
	integer time, time_start, time_end
...
c
c
Cwrite(*,*)iteration,(dsize(i),i=1,2),"before dgm"
...
****************************************************************************
        ...
        SUBROUTINE DISSIPATION(M1,M4,BB,Depsilon,Dro2,DX,DM,igrid)
	integer*4 igrid
        real*8 BB(0:igrid)
...
c
        ...
        DD2=DD2+D2
        D3=DM*(D1**2.)
c check floating errors
c let d3 = 1.0 for now
	D3 = 1.0
        Dro=Dro+D2*D3
10      CONTINUE
