...
c
        ...
        Parameter(BL=20.,BL_inte=20.,teta=.01,Dtur=1.17,Dm=4.64e-5,
     1  Dtemp=4.64e-5)
...
C 	 time_time=iteration*t_use
C	 write(62)time_time,(time_r(i)*1.e6,i=1,6700)
C	 write(67)time_time,(time_s(i),i=1,6700)
C        write(68)time_time,(time_x(i),i=1,6700)
C write(69)ndrop,(index_drop(i),i=1,ndrop)
C endif
