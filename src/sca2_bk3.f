...
c modified 05-08-95
c
	parameter (m_index = 6700)

	real*8 time_r(m_index), time_x(m_index)
Creal*8 time_r(10000),time_qv(10000), time_T(10000),
C    $  time_x(10000),time_s(10000)
c
c modified 05-09-95
c
Cinteger index_drop(7000)
...
C
	 ...
	 if(MOD(iteration,iteration1).eq.0)then
Cprint *, 'writing his ', iteration/iteration1
C  print *, 'm_index is ', m_index
 	  time_time=iteration*t_use
	  write(62)time_time,(time_r(i)*1.e6,i=1,m_index)
Cwrite(67)time_time,(time_s(i),i=1,6700)
          write(68)time_time,(time_x(i),i=1,m_index)
