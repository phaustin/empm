...
***********************************************************************
        parameter(run_info =
     &  'run d02, multi-entm rate = 1.0, d = 0.1 D, dissip rate = 0.01,
*       _________________
     &  nominal RH       ' )
...
* write out field data
         do i = 1, ngrid
            ...
            a_temp2(i) = a(i, 2)
         enddo
c      write(*,*)'t index ', iteration/iteration1, 'T ', T
